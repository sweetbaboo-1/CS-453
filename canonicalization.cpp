...
inline std::string toCannon(std::string path)
{
    ...
    {
        // remove some symbols
        if (canonizedPath[i] == '%'  || canonizedPath[i] == '$'  || canonizedPath[i] == '#' || 
            canonizedPath[i] == '&'  || canonizedPath[i] == '*'  || canonizedPath[i] == ' ' || 
            canonizedPath[i] == '['  || canonizedPath[i] == ']'  || canonizedPath[i] == '|' || 
            canonizedPath[i] == '\\' || canonizedPath[i] == '+'  || canonizedPath[i] == '=' || 
            canonizedPath[i] == '-'  || canonizedPath[i] == '_'  || canonizedPath[i] == '{' || 
            canonizedPath[i] == '}'  || canonizedPath[i] == ','  || canonizedPath[i] == '<' || 
            canonizedPath[i] == '>'  || canonizedPath[i] == '\'' || canonizedPath[i] == '"' || 
            canonizedPath[i] == '`'  || canonizedPath[i] == '~'  || canonizedPath[i] == '(' || 
            canonizedPath[i] == ')'  || canonizedPath[i] == '^'  || canonizedPath[i] == ':' || 
        ...
        if (canonizedPath[i] == '0')
            canonizedPath[i] = 'o';
        else if (canonizedPath[i] == '3')
            canonizedPath[i] = 'e';
        else if (canonizedPath[i] == '5')
            canonizedPath[i] = 's';
        else if (canonizedPath[i] == '!')
            canonizedPath[i] = 'i';
        else if (canonizedPath[i] == '@')
            canonizedPath[i] = 'a';
        else if (canonizedPath[i] == '1')
            canonizedPath[i] = 'l';
        else if (canonizedPath[i] == '8')
            canonizedPath[i] = 'b';
        else if (canonizedPath[i] == '9')
            canonizedPath[i] = 'p';
        else if (canonizedPath[i] == '4')
            canonizedPath[i] = 'a';
        else if (canonizedPath[i] == '6')
            canonizedPath[i] = 'b';
        else if (canonizedPath[i] == '2')
            canonizedPath[i] = 'z';
        else if (canonizedPath[i] == '7')
            canonizedPath[i] = 't';
    }
